package id.ac.umn.week06_28583.PropAnimasi;
...
public class PropAnimasi extends View {
    ...
    public PropAnimasi (Context context) {
        super(context);
    }
    public PropAnimasi(Context context, @Nullable AttributeSet attrs){
        super(context, attrs);
    }
